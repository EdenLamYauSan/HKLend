...
export const zh: Translation = {
  ...
  auth: {
    signIn: {
      ...
      unverifiedEmail: '請先驗證你的電郵地址才能登入。',
      resendVerification: '重新傳送驗證電郵',
      noAccount: '還沒有帳戶？',
      signUpLink: '立即登記',
    },
    sent: {
    ...
    signUp: {
      ...
      signInLink: '登入',
      duplicateEmail: '此電郵地址已被登記，請直接登入。',
      genericError: '發生錯誤，請稍後再試。',
    },
    verifyEmail: {
      verifying: '正在驗證你的電郵…',
      successTitle: '電郵已驗證',
      successBody: '你已成功登入，正在跳轉…',
      expiredTitle: '連結已失效',
      expiredBody: '此驗證連結已被使用或已過期。',
      resend: '索取新連結',
      email: {
        subject: '驗證你的 hklend 電郵',
        linkCta: '驗證電郵',
        expiryLine: '此連結將於 24 小時後失效。',
        ignoreIfNotYou: '如果你沒有在 hklend 建立帳戶，可以安全地忽略此電郵。',
      },
    },
    forgotPassword: {
      title: '重設密碼',
      body: '請輸入你的電郵地址，如帳戶存在，我們將傳送重設連結給你。',
      emailLabel: '電郵地址',
      emailPlaceholder: 'your@email.com',
      submit: '傳送重設連結',
      backToSignIn: '返回登入',
      turnstileFailed: '人機驗證失敗，請重試。',
      sentTitle: '請查收電郵',
      sentBody: '如果此電郵地址有對應帳戶，我們已傳送密碼重設連結。連結將於 15 分鐘後失效。',
      email: {
        subject: '重設你的 hklend 密碼',
        linkCta: '重設密碼',
        expiryLine: '此連結將於 15 分鐘後失效。',
        ignoreIfNotYou: '如果你沒有申請重設密碼，可以安全地忽略此電郵。',
      },
    },
    resetPassword: {
      title: '設定新密碼',
      ...
      submit: '設定密碼',
      expiredTitle: '連結已失效',
      expiredBody: '此重設密碼連結已被使用或已過期。',
      requestNewLink: '索取新的重設連結',
      genericError: '發生錯誤，請稍後再試。',
    },
  },
}
