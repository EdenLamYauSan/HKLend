            ...
            >
              <div className="flex items-center gap-2 p-4">
                ...
                <button
                  ...
                  className="flex h-11 w-11 shrink-0 items-center justify-center rounded-lg text-xl text-[#264a58] hover:bg-[#264a58]/10 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
                >
                  ★
                </button>
              </div>
